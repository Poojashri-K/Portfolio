    ...
    >
        <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                HI, I'm <span className = 'text-purple'>Poojashri Kumar</span>
            </h1>
            <h2 className = 'text-2xl md:text-4xl font-semibold md-6 typewriter'>IT Student</h2>
            <p className='text-lg text-gray-300 mb-8'> An IT student driven by curiosity, always eager to learn, explore, and grow in the tech world.</p>
